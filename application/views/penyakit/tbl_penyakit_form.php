...
<table class='table table-bordered>'        
	    ...
	    <tr><td width='200'>Nm Penyakit <?php echo form_error('nm_penyakit') ?></td><td><input type="text" class="form-control" name="nm_penyakit" id="nm_penyakit" placeholder="Nm Penyakit" value="<?php echo $nm_penyakit; ?>" /></td></tr>
	    
        <tr><td width='200'>Definisi <?php echo form_error('definisi') ?></td><td> <textarea class="form-control" rows="3" name="definisi" id="definisi" placeholder="Definisi"><?php echo $definisi; ?></textarea></td></tr>
	    
        <tr><td width='200'>Solusi <?php echo form_error('solusi') ?></td><td> <textarea class="form-control" rows="3" name="solusi" id="solusi" placeholder="Solusi"><?php echo $solusi; ?></textarea></td></tr>
